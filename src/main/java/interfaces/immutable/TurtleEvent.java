...
public interface TurtleEvent {
  public enum EventKind { USERINPUT, // a command (string) to be parsed: UserInputEvent
                          COMMAND, // an already parsed command: CommandEvent
                          MUDTEXT, // text arriving from the server: MudTextEvent
                          TELNET, // telnet has arrived from the MUD or is generated by us
